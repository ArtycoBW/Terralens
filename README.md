...
- В живых проверках пока нет подтверждённого негативного агрономического случая. Финальная презентация в комплекте не найдена. Эти пробелы и остальные критерии перечислены в [аудите готовности к защите](docs/CASE_AUDIT.md#6-что-завершить-перед-защитой).
...
deliverables/     два отдельных submission и их manifests
